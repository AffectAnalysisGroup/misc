...
def generate_csvs_windowed(nsecs):
	...
	for fid, filename in enumerate(root_name):
		...
		conf_matrix[0, :, :], del_frame1 = compare_windows(rating_pos1, rating_pos2, ann1, ann2, conf_matrix[0, :, :], nsec_frames)
		conf_matrix[1, :, :], del_frame2 = compare_windows(rating_pos2, rating_pos1, ann2, ann1, conf_matrix[1, :, :], nsec_frames)
